...
public class GeofenceTransitionsIntentService extends IntentService {
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        int smsDb= cursor.getInt(5);
        int wifiDb= cursor.getInt(6);
        int silDb= cursor.getInt(7);
        int RemDb= cursor.getInt(8);
        String remMsgDb= cursor.getString(9);
        ...
        if (geofenceTransition == Geofence.GEOFENCE_TRANSITION_ENTER ||
            ...
            if(smsDb==1){
                ...
                sm.sendTextMessage("+12149832121", null, "Hi, I am in ERB right now!!!", null, null);
            }
        } else {
